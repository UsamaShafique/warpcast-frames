...
async function getResponse(req: NextRequest): Promise<NextResponse> {
  ...
  if (idAsNumber === 4) {
    ...
    <meta property="fc:frame:button:1:target" content="https://github.com/UsamaShafique" />
  ...
  return new NextResponse(`<!DOCTYPE html><html><head>
    ...
    <meta property="fc:frame" content="vNext" />
    <meta property="fc:frame:input:text" content="Enter Your #Hashtag" />
    <meta property="fc:frame:button:1" content="Next Page" />
    <meta property="fc:frame:post_url" content="${process.env.NEXT_PUBLIC_SITE_URL}/api/basic?id=${nextId}" />
    <meta property="fc:frame:button:2" content="Previous Page" />
    <meta property="fc:frame:post_url" content="${process.env.NEXT_PUBLIC_SITE_URL}/api/basic?id=${nextId}" />
  </head></html>`)
}
